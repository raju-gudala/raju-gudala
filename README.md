...
**230V AC → 360V DC @ 8A → 24V DC @ 100A / 2.4kW**

Designed for high-power UAV operation with real-time telemetry and automatic failover arbitration.

### ⚡ Adjustable DC-DC Buck Converter

Wide-input **5–40V** buck converter using the LM2596S-ADJ with adjustable **3.3–15V / 3A** output, UVLO, and EMI filtering — complete schematic-to-PCB design flow.
